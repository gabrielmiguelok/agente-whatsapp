          ...
          return (
            ...
            >
              {row.getVisibleCells().map((cell, cIndex) => {
                ...
                // VALIDACIÓN ROBUSTA: Es select si tiene editType='select' Y (tiene opciones O tiene useDynamicOptions)
                ...
                if (inEditingMode && isSelectField) {
                  console.log('🔧 [TABLEBODY] Renderizando dropdown para', colId, ':', {
                  ...
                  isSelectField ? (
                    <CustomSelectDropdown
                      ...
                      onChange={(newValue) => {
                        ...
                        // CRÍTICO: Crear evento sintético INMEDIATAMENTE
                      ...
                      onCreateOption={columnMeta?.onCreateOption}  // ← NUEVO: Callback opcional
                      dataset={columnMeta?.dataset}  // ← NUEVO: Dataset opcional
                    />
                  ) : isNumericField ? (
                    <input
