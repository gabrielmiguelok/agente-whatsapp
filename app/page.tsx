/************************************************************
 * app/page.tsx
 * Nexus CRM - Panel Unificado Premium
 ************************************************************/
...
type MainTab = 'contacts' | 'messages' | 'whatsapp' | 'config';
      ...
      >
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all"
            ...
            <motion.button
              ...
              className="w-full py-3.5 px-4 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-emerald-500/25 disabled:shadow-none"
            >
              {loading ? (
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            Nexus CRM v2.0 - Todos los derechos reservados
          </p>
        </div>
      </motion.div>
    </div>
...
export default function Home() {
  ...
  // Data states
  const [selectedDataset, setSelectedDataset] = useState<'contacts' | 'messages'>('contacts');
  ...
  // Prompt config states
  const [promptConfig, setPromptConfig] = useState<PromptConfig | null>(null);
  const [promptLoading, setPromptLoading] = useState(false);
  const [saveSuccess, setSaveSuccess] = useState(false);

  // Hook para datos de tabla
  ...
  useEffect(() => {
    if (isAuthenticated && (activeTab === 'contacts' || activeTab === 'messages')) {
      refetch();
    }
  ...
  useEffect(() => {
    if (isAuthenticated && (activeTab === 'whatsapp' || activeTab === 'config')) {
      initializeSession();
      fetchPromptConfig();
    }
  }, [isAuthenticated, activeTab, initializeSession, fetchPromptConfig]);
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900 dark:text-white">Nexus CRM</h1>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-4 mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-500 dark:text-gray-400">
          Nexus CRM v2.0 - Automatización inteligente de WhatsApp con IA
        </div>
      </footer>
    </div>
  );
